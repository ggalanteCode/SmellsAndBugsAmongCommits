...
public class PhDSmells implements Tool {
    private static final String RUNWIN ="..\\src\\main\\java\\tools\\toolsfolder\\PhDProjectScripts";
    private static final String RUNLIN ="..\\src\\main\\java\\tools\\toolsfolder\\PhDProjectScripts";
