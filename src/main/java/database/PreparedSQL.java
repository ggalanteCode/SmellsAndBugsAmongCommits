...
public class PreparedSQL {
    ...
    */
    ...
    public static final String CODESHOVELMETHODS = "create table codeshovelmethods (\n"+
            ...
            "previousversion text not null, \n"+	//if the method is NEW, there is no previousVer
            "type text not null, \n"+
            ...
            "    primary key(currentversion, previousversion, class,methodsignature), \n" +
            "foreign key(currentversion, previousversion, class)"
            + "references codeshovelclasses(currentversion, previousversion, completeclassname) on delete cascade on update cascade"+
            ");";
    public static final String CODESHOVELCLASSES = "create table codeshovelclasses (\n"+
            "id serial not null, \n"+
            "completeclassname text not null, \n"+
            "type text not null, \n"+
            "currentversion text not null, \n"+
            "previousversion text not null, \n"+
            "classname text not null, \n"+
            "    primary key(currentversion, previousversion, completeclassname) \n" +
            ");";
    ...
    public static final String INSERTCODESHOVELMETHOD = "insert into codeshovelmethods (class, methodname, currentversion, previousversion, type, locadded, locdeleted, locmodified, methodsignature, static, public, protected, final, abstract, transient, synchronized, volatile) values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?);";

    public static final String INSERTCODESHOVELCLASS = "insert into codeshovelclasses (completeclassname, type, currentversion, previousversion, classname) values (?,?,?,?,?);";
    ...
    //NUOVA QUERY
    public static final String GETURLBYPROJECTPATH = "select url from project where path = ? ;";
    ...
    //public static final String GETCODESHOVELCLASS = "select * from codeshovelclasses where currentversion = ? and previousversion = ? and class = ?";
    
    public static final String GETPROJECTPATH = "select path from project where url = ?;";
    
    
    
    
    
    // QUERY CONTROLLO JCODE,SOURCEMETER & CODESHOVEL
    ...
    public static final String CSCLASSALREADYEXISTS = "select codeshovelclasses.id from codeshovelclasses where currentversion = ? and previousversion = ? and completeclassname = ?";
    
    public static final String UPDATECSCLASSCHANGETYPE = "update codeshovelclasses set type = ?, previousversion = ? where currentversion = ? and previousversion = '' and class = ?";
