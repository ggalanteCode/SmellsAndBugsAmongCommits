...
public class CommitPicker extends javax.swing.JFrame {
    ...
    */
    ...
    private void analyzeBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_analyzeBActionPerformed
        ...
        String [] possibleNamesBuildFile = {"POM.xml","pom.xml","Pom.xml", "build.xml", "Build.xml"/*, "build.gradle", "Build.gradle"*/};
        File buildFile;
        ...
        try {
            ...
            c = commitList.getSelectedValue();
            if(c == null) {
            	new Dialog("Please select a commit!");
            } else {
            	this.rh.checkoutCommit(c.getVersion());
            }
        } catch (Exception ex) {
            Logger.getLogger(CommitPicker.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        if(c == null) {
        	...
        	dispose();
        	new Parameters(p,c.getVersion(), rh);
        }
